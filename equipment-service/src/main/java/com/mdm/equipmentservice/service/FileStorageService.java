...
public interface FileStorageService {
    ...
    List<FileStorage> uploadMultipleFiles(String associatedEntityType, Long associatedEntityId, FileDescription fileDescription,
    ...
    /**
     * Get all FileStorage without data of an entity with the specified entity id and file description
     *
     * @param associatedEntityType (e.g. "User")
     * @param associatedEntityId   (e.g. 1)
     * @param fileDescription      (e.g. FileDescription.IMAGE), if null, get all files (images and documents)
     * @return list of {@link FileStorageDto}
     */
    ...
    /**
     * @param associatedEntityType (e.g. "User")
     * @param associatedEntityIds  (e.g. List.of(1L,2L,3L))
     * @param fileDescription      (e.g. FileDescription.IMAGE), if null, get all files (images and documents)
     * @return list of {@link FileStorageDto}
     */
    List<FileStorageDto> getAllFilesFromListOfEntityIdsWithoutData(String associatedEntityType, List<Long> associatedEntityIds,
