...
public class StatisticServiceImpl implements StatisticService {
    ...
    public StatisticDashboardDto getStatisticDashboard() {
        ...
        Set<StatisticDashboardDto.CountByDepartment> countEquipmentByDepartmentList = new HashSet<>();
        Set<StatisticDashboardDto.CountByRiskLevel> countEquipmentByRiskLevelList = new HashSet<>();
        Set<StatisticDashboardDto.CountByEquipmentStatus> countEquipmentByStatusList = new HashSet<>();
        Set<StatisticDashboardDto.CountByDepartment> countRepairingByDepartmentList = new HashSet<>();
        Set<StatisticDashboardDto.CountByDepartment> countBrokenByDepartmentList = new HashSet<>();
