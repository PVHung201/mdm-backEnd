...
public class FileStorageServiceImpl implements FileStorageService {
    ...
    public FileStorageServiceImpl(
            FileStorageRepository fileStorageRepository, MessageUtil messageUtil,
    ...
    public List<FileStorage> getAllFilesOfAnEntity(String associatedEntityType, Long associatedEntityId, FileDescription fileDescription) {
        return fileStorageRepository.findAll(FileStoragePredicate.getFileStoragePredicate(GetFileStoragesQueryParam.builder()
    ...
    @Override
    public List<FileStorageDto> getAllFilesFromListOfEntityIdsWithoutData(String associatedEntityType, List<Long> associatedEntityIds,
                                                                          FileDescription fileDescription) {
        List<FileStorage> fileStorages = fileStorageRepository.findAll(FileStoragePredicate.getAllFileStorgesFromEntityIds(GetFileStoragesQueryParam.builder()
                .listOfAssociatedEntityId(associatedEntityIds)
                .associatedEntityType(associatedEntityType)
                .fileDescription(fileDescription)
                .build()), Sort.by("associatedEntityId"));
        return fileStorages.stream().map(fileStorageMapper::toDto).toList();
    }
    ...
    public void deleteAllFilesOfAnEntity(String associatedEntityType, Long associatedEntityId, FileDescription fileDescription) {
        List<FileStorage> fileStorages = fileStorageRepository.findAll(FileStoragePredicate.getFileStoragePredicate(GetFileStoragesQueryParam.builder()
                .fileDescription(fileDescription)
                .associatedEntityId(associatedEntityId)
                .associatedEntityType(associatedEntityType)
                .build()));
