...
public interface MaintenanceTicketService {
    ...
    Page<EquipmentListMaintenanceDto> getAllEquipmentsForMaintenance(GetEquipmentsForMaintenanceQueryParam getEquipmentsForMaintenanceQueryParam,
                                                                     Pageable pageable);

    @PreAuthorize("hasAnyRole('ROLE_ADMIN','ROLE_TPVT') or hasAuthority(\"MAINTENANCE.CREATE\")")
    MaintenanceTicketFullInfoDto createMaintenanceTicket(CreateMaintenanceTicketForm createMaintenanceTicketForm, Long equipmentId,
    ...
    MaintenanceTicketFullInfoDto updateMaintenanceTicket(Long equipmentId, Long maintenanceId, UpdateMaintenanceTicketForm acceptMaintenanceTicketForm,
                                                         MultipartFile[] attachments);
