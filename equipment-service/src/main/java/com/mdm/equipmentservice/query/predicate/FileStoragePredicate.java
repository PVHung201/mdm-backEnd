...
public class FileStoragePredicate {
    ...
    public static Predicate getAllFileStorgesFromEntityIds(GetFileStoragesQueryParam getFileStoragesQueryParam) {
        BooleanBuilder booleanBuilder = new BooleanBuilder();
        return booleanBuilder.and(matchAssociatedEntityType(getFileStoragesQueryParam.getAssociatedEntityType()))
                .and(matchAssociatedEntityId(getFileStoragesQueryParam.getAssociatedEntityId()))
                .and(associatedEntityIdIn(getFileStoragesQueryParam.getListOfAssociatedEntityId()));
    }
    ...
    public static Predicate associatedEntityIdIn(List<Long> listOfAssociatedEntityId) {
        return listOfAssociatedEntityId == null || listOfAssociatedEntityId.isEmpty() ? fileStorage.associatedEntityId.in(listOfAssociatedEntityId) : null;
    }
