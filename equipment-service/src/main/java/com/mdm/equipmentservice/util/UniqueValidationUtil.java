    ...
    public <ENTITY> void validateUnique_throwExceptionIfHasError(
        ...
        if (!errors.isEmpty()) {
            throw new ValidationFailedException(
                    StringUtils.isNotBlank(customMessage) ? customMessage : messageUtil.getMessage("uniquenessValidationFailed"),
                    errors
            );
        }
    }
    ...
    public <ENTITY> List<String> validateUnique(
        ...
        listOfUniqueFieldNames.parallelStream().forEach(fieldName -> {
            ...
            try {
                ...
                List<ENTITY> result = queryEntityInDbByExample(
                        (Class<ENTITY>) entityToBeValidated.getClass(),
                        entityRepository,
                        fieldName,
