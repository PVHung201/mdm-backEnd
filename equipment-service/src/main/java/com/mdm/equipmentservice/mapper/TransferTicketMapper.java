...
public abstract class TransferTicketMapper {
    ...
    @Mapping(
            target = "attachments",
            expression = "java(fileStorageService.getAllFilesOfAnEntityWithoutData(transferTicket.getClass().getSimpleName(), transferTicket.getId(), FileDescription.DOCUMENT))"
    )
