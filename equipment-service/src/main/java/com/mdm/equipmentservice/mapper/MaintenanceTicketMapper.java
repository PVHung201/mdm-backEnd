...
public abstract class MaintenanceTicketMapper {
    ...
    @Mapping(
            target = "attachments",
            expression = "java(fileStorageService.getAllFilesOfAnEntityWithoutData(maintenanceTicket.getClass().getSimpleName(), maintenanceTicket.getId(), FileDescription.DOCUMENT))"
    )
