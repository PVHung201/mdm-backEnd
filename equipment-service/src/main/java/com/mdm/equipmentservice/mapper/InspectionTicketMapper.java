...
import com.mdm.equipmentservice.model.dto.base.InspectionTicketDto;
...
public abstract class InspectionTicketMapper {
    ...
    @Mapping(
            target = "attachments",
            expression = "java(fileStorageService.getAllFilesOfAnEntityWithoutData(inspectionTicket.getClass().getSimpleName(), inspectionTicket.getId(), FileDescription.DOCUMENT))"
    )
