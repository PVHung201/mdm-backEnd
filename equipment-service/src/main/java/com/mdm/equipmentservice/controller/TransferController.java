...
public class TransferController {
    ...
    @Autowired
    public TransferController(MessageUtil messageUtil, TransferTicketService transferTicketService,
                              PagedResourcesAssembler<EquipmentListTransferDto> pagedResourcesAssembler) {
