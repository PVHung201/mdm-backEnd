...
public class MaintenanceController {
    ...
    public ResponseEntity<GenericResponse<MaintenanceTicketFullInfoDto>> createMaintenanceTicket(
        ...
        MaintenanceTicketFullInfoDto maintenanceTicketFullInfoDto = maintenanceTicketService.createMaintenanceTicket(
    ...
    public ResponseEntity<GenericResponse<MaintenanceTicketFullInfoDto>> acceptMaintenanceTicket(
        ...
        MaintenanceTicketFullInfoDto maintenanceTicketFullInfoDto = maintenanceTicketService.acceptMaintenanceTicket(
                equipmentId,
                maintenanceId,
    ...
    public ResponseEntity<GenericResponse<MaintenanceTicketFullInfoDto>> updateMaintenanceTicket(
        ...
        MaintenanceTicketFullInfoDto maintenanceTicketFullInfoDto = maintenanceTicketService.updateMaintenanceTicket(
                equipmentId,
                maintenanceId,
    ...
    public ResponseEntity<GenericResponse<PagedModel<EntityModel<EquipmentListMaintenanceDto>>>> getAllEquipmentsForMaintenance(
        ...
        Page<EquipmentListMaintenanceDto> allEquipmentsForMaintenance =
                maintenanceTicketService.getAllEquipmentsForMaintenance(getEquipmentsForMaintenanceQueryParam, pageable);
    ...
    public ResponseEntity<GenericResponse<Page<MaintenanceTicketListDto>>> getAllMaintenanceTicketsOfAnEquipment(
        ...
        Page<MaintenanceTicketListDto> allMaintenanceTicketsOfAnEquipment = maintenanceTicketService.getAllMaintenanceTicketsOfAnEquipment(
                equipmentId,
                pageable
        );
