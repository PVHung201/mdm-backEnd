...
public class SupplyController {
    ...
    private final PagedResourcesAssembler<SupplyFullInfoDto> pagedResourcesAssembler;

    public SupplyController(SupplyService supplyService, PagedResourcesAssembler<SupplyFullInfoDto> pagedResourcesAssembler) {
