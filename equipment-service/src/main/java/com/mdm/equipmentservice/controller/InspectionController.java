...
public class InspectionController {
    ...
    public InspectionController(
            MessageUtil messageUtil, InspectionTicketService inspectionTicketService,
            PagedResourcesAssembler<EquipmentListInspectionDto> pagedResourcesAssembler
    ) {
    ...
    public ResponseEntity<GenericResponse<InspectionTicketFullInfoDto>> createInspectionTicket(
        ...
        InspectionTicketFullInfoDto inspectionFullInfoDto = inspectionTicketService.createInspectionTicket(
                createInspectionTicketForm,
                equipmentId,
                attachments
        );
    ...
    public ResponseEntity<GenericResponse<PagedModel<EntityModel<EquipmentListInspectionDto>>>> getAllEquipmentForInspection(
        ...
        Page<EquipmentListInspectionDto> allEquipmentsForInspection = inspectionTicketService.getAllEquipmentsForInspection(
                getEquipmentsForInspectionQueryParam,
                pageable
        );
    ...
    public ResponseEntity<GenericResponse<InspectionTicketFullInfoDto>> acceptInspectionTicket(
        ...
        InspectionTicketFullInfoDto inspectionTicketFullInfoDto = inspectionTicketService.acceptInspectionTicket(
                equipmentId,
                inspectionId,
    ...
    public ResponseEntity<GenericResponse<InspectionTicketFullInfoDto>> updateInspectionTicket(
        ...
        InspectionTicketFullInfoDto inspectionTicketFullInfoDto = inspectionTicketService.updateInspectionTicket(
                equipmentId,
                inspectionId,
    ...
    public ResponseEntity<GenericResponse<Page<InspectionTicketListDto>>> getAllInspectionTicketsOfAnEquipment(
        ...
        Page<InspectionTicketListDto> allInspectionTicketsOfAnEquipment = inspectionTicketService.getAllInspectionTicketsOfAnEquipment(
                equipmentId,
                pageable
        );
