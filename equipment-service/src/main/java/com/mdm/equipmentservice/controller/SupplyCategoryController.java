...
public class SupplyCategoryController {
    ...
    public ResponseEntity<GenericResponse<PagedModel<EntityModel<SupplyCategoryDto>>>> getSupplyCategories(
        ...
        PagedModel<EntityModel<SupplyCategoryDto>> entityModels =
                supplyCategoryWithUserDtoPagedResourcesAssembler.toModel(supplyCategoryService.getSupplyCategories(
